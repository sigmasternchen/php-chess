...
class PeSTO implements Heuristic {
    ...
    private const endgamePawnTable = [
        0,   0,   0,   0,   0,   0,   0,   0,
    ...
    private const middlegameKnightTable = [
    ...
    private const endgameKnightTable = [
    ...
    private const middlegameBishopTable = [
    ...
    private const endgameBishopTable = [
    ...
    private const middlegameRookTable = [
    ...
    private const endgameRookTable = [
    ...
    private const middlegameQueenTable = [
    ...
    private const endgameQueenTable = [
    ...
    private const middlegameKingTable = [
    ...
    private const endgameKingTable = [
    ...
    private const normalizationFactor = 1/500;

    private const middlegamePieceValues = [82, 337, 365, 477, 1025,  0];
    private const endgamePieceValues = [94, 281, 297, 512,  936,  0];

    private array $middlegameTable;
    private array $endgameTable;
    
    public function __construct() {
        $this->middlegameTable = [
